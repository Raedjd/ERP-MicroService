...
const Settings = () => {
  ...
  const [nationnality,setNationnality]=useState('');
  ...
  const updateProfil = async (e) => {
    e.preventDefault();
      ...
      await axios({
        method: "put",
        url: `${process.env.REACT_APP_API_URL}/user/update/${id}`,
  ...
  return (
          ...
          <div>
            <ValidatorForm onSubmit={updateProfil} onError={() => null}>
              ...
              <Grid container spacing={6}>
                <Grid item lg={6} md={6} sm={12} xs={12} sx={{ mt: 2 }}>
                  ...
                  <Autocomplete
                      ...
                      onChange={(e , v) => setNationnality(v.label) }
